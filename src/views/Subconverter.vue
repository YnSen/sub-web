...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "sendesub.vercel.app (自动编译最新版本后端-测试）": "https://sendesub.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://sendesub.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://sendesub.vercel.app/sub?";
